...
python ~/EphysAnalysis/scripts/run_dimensionality.py /bgfs/balbanna/jmt195/Opsin_Cache /bgfs/balbanna/jmt195/results_experiment_RevLearn_dimensionality_opsin_highIters_s6 6 50 10 100 dimenstionality_opsin_highIters_s6