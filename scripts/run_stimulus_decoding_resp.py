...
if __name__ == "__main__":
    ...
    print("Starting experiment_run_stimulus_decoding_resp.py")
    ...
    for session,clust in progress_bar:
        ...
        try:
            ...
            interval = ilep.TrialInterval(0,0,False,True)
    ...
    results_df.to_csv(os.path.join(full_dir, "stimdecoding_resp.csv"))