...
python ~/EphysAnalysis/scripts/run_dimensionality.py /bgfs/balbanna/jmt195/Analysis_Cache /bgfs/balbanna/jmt195/results_experiment_RevLearn_dimensionality_highIters_s6 6 50 10 100 dimenstionality_highIters_s6