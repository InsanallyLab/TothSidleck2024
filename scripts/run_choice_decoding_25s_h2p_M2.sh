...
python ~/EphysAnalysis/scripts/run_choice_decoding_25s_M2.py /bgfs/minsanally/tih85/Analysis_Cache /bgfs/minsanally/tih85/results_experiment_RevLearn_choicedecoding_resp 500 response