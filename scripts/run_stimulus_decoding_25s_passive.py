...
if __name__ == "__main__":
    ...
    print("Starting experiment_run_stimulus_decoding_25s_passive.py")
    ...
    for session in sessions:
        ...
        if not sessionfile.meta.task == 'passive no behavior':
            continue
    ...
    results_df.to_csv(os.path.join(full_dir, "stimdecoding_25s_passive.csv"))