...
if __name__ == "__main__":
    full_dir='/bgfs/minsanally/tih85'
    print("Starting experiment_run_choice_decoding_25s_M2.py")
    ...
    for session in sessions:
        ...
        # if sessionfile.meta.animal == 'BS_72':
        #     continue
    ...
    try:
        with open('/bgfs/minsanally/tih85/trialsToUsePerDay', 'rb') as f:
    ...
    results_df.to_csv(os.path.join(full_dir, "choicedecoding_25s.csv"))