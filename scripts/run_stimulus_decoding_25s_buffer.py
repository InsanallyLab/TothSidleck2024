...
if __name__ == "__main__":
    ...
    print("Starting experiment_run_stimulus_decoding_25s_buffer.py")
    ...
    for session,clust in progress_bar:
        ...
        try:
            ...
            interval = ilep.TrialInterval((0.0-0.2)*30000,(2.5)*30000,False,False)
            temp = pool.apply_async(ilep.calculateDecodingForSingleNeuron,(session,clust,trialsPerDayLoaded,CACHE_DIRECTORY,OUTPUT_DIRECTORY,interval,REPETITIONS,CATEGORIES))
    ...
    results_df.to_csv(os.path.join(full_dir, "stimdecoding_25s_buffer.csv"))